...
* This constraint presently rules out porting Grid to AMD GPUs which do not support managed memory.

* At some point in the future a cacheing strategy may be implemented to enable running on AMD GPUs

 ...
 * However,
 * fermions are implemented in the following `.cc` files.
 *
 * - CayleyFermion5D.cc
 ...
 *
 * As such,
 * explicit template instantiation is still required
 * Instantiations are generated by generate_instantiations.sh;
 * any instantiation not listed there will not be usable.
 * A subset of these instantations is selected at `configure` time.
 *

...
Source file: ./tests/Test_hmc_LLR_WilsonGauge.cc
...
int main(int argc, char **argv) {
    std::cout<<"Start Test_hmc_LLR_WilsonGauge.cc" <<std::endl;
    ...
    // End statement
    std::cout<<"End Test_hmc_LLR_WilsonGauge.cc" <<std::endl;
} /* end of main Test_hmc_LLR_WilsonGauge.cc */

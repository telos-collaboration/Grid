#!/bin/bash
#SBATCH --job-name=Run_LLR_HMC_SUn_WilsonGauge_nodes001_mpi01-01-01-04
...
grid_dwf_telos_build_dir=$grid_dwf_telos_dir/build-SU3-withLLR
...
echo `date`
echo "- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -"
echo "- /home/dp208/dp208/dc-bonn2/SwanSea/SourceCodes/Grid-Telos-Devel/Run_LLR_HMC_SUn_WilsonGauge_nodes001_mpi01-01-01-04.sh Done. -"
echo "- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -"
